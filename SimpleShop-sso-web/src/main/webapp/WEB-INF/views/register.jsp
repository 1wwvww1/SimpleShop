...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="http://static.simpleshop.com/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="http://static.simpleshop.com/css/passport.base.css"/>
...
<div class="w" id="logo">
    <div>
    	<a href="http://www.taotao.com/">
    		<img src="http://static.simpleshop.com/images/taotao-logo.gif" alt="京东商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://sso.simpleshop.com/user/login.html"
    ...
    <div class="mc">
        <form id="personRegForm" method="POST" onsubmit="return false;">
            ...
            <div class="phone">
                <img width="180" height="180" src="http://static.simpleshop.com/images/phone-bg.jpg">
            </div>
                        <span class="clr"></span>
        </form>
    </div>
...
<script type="text/javascript" src="http://static.simpleshop.com/js/register/jd.lib.js"></script>
<script type="text/javascript" src="http://static.simpleshop.com/js/register/jdThickBox.js"></script>
<script type="text/javascript" src="http://static.simpleshop.com/js/register/jdValidate.js"></script>
<script type="text/javascript" src="http://static.simpleshop.com/js/register/jdValidate.emReg.js"></script>
<script type="text/javascript" src="http://static.simpleshop.com/js/register/jdValidate.regSuccess.js"></script>
