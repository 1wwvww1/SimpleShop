...
<body> 
<!--shortcut start-->
<jsp:include page="../../../../SimpleShop-web/src/main/webapp/WEB-INF/commons/shortcut.jsp" />
<!--shortcut end-->
...
<!-- footer start -->
<jsp:include page="../../../../SimpleShop-web/src/main/webapp/WEB-INF/commons/footer.jsp" />
<!-- footer end -->
