...
var category = {OBJ: $("#_JD_ALLSORT"),
		URL_Serv: "http://localhost:8081/rest/api/item/cat?callback=category.getDataService",//"/js/itemCat.json", //"http://localhost:8081/rest/item/cat""http://manage.taotao.com/web/itemcat/all?callback=category.getDataService",
