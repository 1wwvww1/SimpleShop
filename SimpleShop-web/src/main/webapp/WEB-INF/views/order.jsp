...
<!--shortcut end-->
	<form id="orderForm" class="hide">
		<input type="hidden" name="paymentType" value="1"/>
			...
			<input type="hidden" name="orderItems[0].totalFee" value="${item.price*10}"/>
