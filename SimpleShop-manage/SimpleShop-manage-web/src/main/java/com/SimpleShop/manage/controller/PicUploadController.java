...
import com.SimpleShop.manage.bean.PicUploadResult;
import com.SimpleShop.manage.service.PropertieService;
...
public class PicUploadController {
	...
	*/
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile , HttpServletResponse response) throws Exception {
		...
		System.out.println("filePath:"+filePath+"respPath"+propertieService.REPOSITORY_PATH);
		...
		System.out.println("fileUploadUrl: "+fileUploadResult.getUrl());
	...
	private String getFilePath(String sourceFileName) {
		String baseFolder = this.propertieService.REPOSITORY_PATH + File.separator + "images";
