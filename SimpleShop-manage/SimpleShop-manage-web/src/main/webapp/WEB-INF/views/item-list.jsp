                        ...
                        statusCode: {
                            200 : function (data) {
                                if( data && data.paramData){
                                    ...
                                    $("#itemeEditForm [name=paramData]").val(data.paramData);
                                    $("#itemeEditForm [name=itemId]").val(data.itemId);
                            ...
                            // 400 : function() {
                            //     $.messager.alert('提示','新增商品失败!请查看填写完整');
                            // } ,
                            500 : function () {
                                $.messager.error('提示','服务器正忙，请稍后!');
                            }
                        }
                    });
